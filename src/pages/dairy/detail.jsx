...
export const DetailPage = () => {
  const { type, title, date, content, meta } = mockData2

  return (
    <RootLayout>
      <Header title={title} date={date} type={type} />
      {/* 내용물 구현 */}
...
const Strategy = ({ meta, content }) => {
  return (
    <>
      ...
      <Button>AI에게 투자 전략 조언 받기</Button>
    </>
  )
}
